    ...
    if st.button(
        ...
        try:
            ...
            st.success(
                ...
                "were synced to the generated voice."
            )
    ...
    if (
        ...
        if ret_blur:
            ...
            st.caption(
                ...
                "Original Subtitle ပေါ်က Rectangle ကို "
                "ဆွဲပါ။"
            )
            ...
            #
            # IMPORTANT:
            # No display_toolbar=True
            # because this can cause TypeError on
            # some Streamlit / drawable-canvas versions.
            # =================================================
